    ...
    <div class="case-list unit-list clearfix">
        <div class="search-wrapper">
            <div class="search-box">
                <input type="text" id="search_input" autocomplete="off"
                       value="<?= isset($_GET['search']) ? $_GET['search'] : '' ?>" class="search-input"
                       placeholder="请输入筛选内容">
        ...
        <?php if (!isset($_GET['page']) || $_GET['page'] == 1) { ?>
            <a href="/unit/dingzhi" animate-type="slideInUp" class="case-item animated ">
                <img style="background-color:rgb(<?= rand(0, 255); ?>,<?= rand(0, 255); ?>,<?= rand(0, 255); ?>)"
                ...
                <p class="case-info">
                    <button class="fy-btn fy-btn-danger" style="width: 100%;padding:8px 0;margin-top:10px;">发布定制
                    </button>
                </p>
            </a>
        <?php } ?>
