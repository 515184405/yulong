...
<style>
    ...
    ul, li{margin:0px; padding:0px; list-style:none;}ul{clear:both;width:91%;margin-left: auto;margin-right: auto;}.title{width:100%;font-size: 18px;}
...
<div style="display: table;width: 100%;">
    <ul>
        ...
        <?php foreach ($data as $key=>$val) { ?>
            <li class="lks"><span><?=$key?></span><a href="/unit?id=<?=$val['type_id']?>&title=<?=$val['title']?>" title="<?=$val['title']?>" target="_blank"><?=$val['title']?></a></li>
        <?php } ?>
    </ul>
</div>