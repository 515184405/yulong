...
class UserController extends CommonController
{
    ...
    public function actionIndex()
    {
        ...
        $widget = Widget::find()->select(['id','title','desc','banner_url','look','fail_msg','collect','down_count','status','upload_download'])->where(['status'=>$status,'u_id'=>$uid])->orderBy(['id'=>SORT_DESC,'upload_download'=>SORT_STRING]);
...
//        var_dump($data);die;
    ...
    public function actionScopeRecord()
    {
        ...
        $user_scope_record = UserScopeRecord::find()->where($where)->andWhere(['>', 'scope', 0])->orderBy(['id'=>SORT_DESC]);
