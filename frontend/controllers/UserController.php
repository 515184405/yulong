...
class UserController extends CommonController
{
    ...
    public function actionIndex()
    {
        ...
        $widget = Widget::find()->select(['id','title','desc','banner_url','look','fail_msg','collect','down_count','status','upload_download'])->where(['status'=>$status,'u_id'=>$uid])->orderBy(['upload_download'=>SORT_ASC]);
