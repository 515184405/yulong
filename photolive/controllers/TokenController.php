...
class TokenController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        Yii::$app->getResponse()->headers->set('Access-Control-Allow-Methods', "GET, POST, PUT,DELETE");
        Yii::$app->getResponse()->headers->set("Access-Control-Max-Age", "86400");
        Yii::$app->getResponse()->headers->set('Access-Control-Allow-Headers', "Origin, X-Requested-With, Content-Type, Accept,key,token");
