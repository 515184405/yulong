...
class TokenController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        Yii::$app->getResponse()->headers->set('Access-Control-Allow-Methods', "PUT,POST,GET,DELETE,OPTIONS");
        Yii::$app->getResponse()->headers->set('Access-Control-Allow-Headers', "content-type,Access-token,token");
        Yii::$app->getResponse()->headers->set('X-Powered-By', " 3.2.1");
