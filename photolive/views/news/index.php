    ...
    <div class="layui-card-body">
        ...
        <script type="text/html" id="test-table-toolbar-toolbarDemo">
            <div class="layui-btn-container">
                <a href="/news/info" class="layui-btn layui-btn-sm">添加新闻</a>
                <a href="/news/type" class="layui-btn layui-btn-sm">添加类型</a>
            </div>
        </script>
    ...
    layui.config({
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'title',title: '标题',templet: function (d) {
                       return '<a target="_blank" class="theme" href="'+frontend_url+'/news/item/'+d.id+'"> '+d.title+' </a>';
                    }}
        ...
        table.on('tool(test-table-toolbar)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                window.location.href = '/news/info/?id='+data.id;
            }
        });
