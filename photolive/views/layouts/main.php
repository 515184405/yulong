        ...
        <div id="layui-side-menu" class="layui-side layui-side-menu">
            <div class="layui-side-scroll">
                <div class="layui-logo" lay-href="home/console.html">
                    <span><img style="width: 135px;margin-top:-15px;" src="<?=Yii::$app->params["backend_url"]?>/asset/image/logo-fff.png" alt=""></span>
                </div>
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    ...
                    <li data-name="banner" class="layui-nav-item">
                    ...
                    <li data-name="type" class="layui-nav-item">
                        <a href="/photo-type" lay-tips="应用场景管理" lay-direction="2">
