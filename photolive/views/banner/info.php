    ...
    <div class="layui-card-body">
        <form class="layui-form" action="">
            ...
            <div id="wx_link" class="layui-form-item ">
                ...
                <div class="layui-input-block">
                    <button type="button" class="layui-btn layui-btn-primary js_upload_image" id="test-upload-normal">上传图片</button><span class="theme-red ml10">1920 * 550，图片大小不要超过2M</span>
