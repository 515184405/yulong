        ...
        <form class="layui-form" action="">
           ...
           <!-- <div id="wx_link" class="layui-form-item ">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" <?=$data['scope'] == 0 ? "" : 'disabled'?> value="<?=$data['scope'] == 0 ? 5 : $data['scope']?>" name="create_scope" autocomplete="off" placeholder="上传项目所获得的积分" class="layui-input <?=$data['scope'] == 0 ? '' : 'layui-disabled'?>">
