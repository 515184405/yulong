    ...
    <div class="layui-card-body">
        <form class="layui-form" action="">
            ...
            <div id="wx_link" class="layui-form-item ">
                ...
                <div class="layui-input-block">
                    <button type="button" class="layui-btn layui-btn-primary js_upload_image" id="test-upload-normal">上传图片</button><span class="theme-red ml10">透明图片，以.png为结尾，图片大小不要超过2M</span>
                    <input type="hidden" lay-verify="required" lay-text="轮播图必填" value="<?=isset($data['banner']['banner_url']) ? $data['banner']['banner_url'] : ''?>" class="js_banner_url" name="banner_url">
                    <div class="layui-upload-list">
                        <img class="layui-upload-img" <?=isset($data['banner']['banner_url']) ? 'src="'.$data['banner']['banner_url'].'"' : ''?>" id="test-upload-normal-img">
